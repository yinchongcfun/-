      ...
      <form class="form form-horizontal" action="<?php echo U('Login/checkLogin');?>" method="post">
        <div class="row cl">
          ...
          <div class="formControls col-xs-8">
            <?php if($name != null): ?><input id="" name="name" type="text" value="<?php echo ($name); ?>"  placeholder="用户名" class="input-text size-L">
              <?php else: ?>
              <input    name="name"  type="text" placeholder="用户名" class="input-text size-L"><?php endif; ?>
          </div>
        </div>
        <div class="row cl">
          <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
